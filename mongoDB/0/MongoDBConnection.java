...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "romariosistemas";
    private static final String PASSWORD = "DEVas8EeQrKrMvZf";
    private static final String CLUSTER_URL = "learnmongo.gula7my.mongodb.net"; // Substitua pelo seu cluster se for diferente
    private static final String DATABASE_NAME = "LearnMongo"; // Substitua pelo nome do seu banco de dados
